...
report_sxw.report_sxw('report.neopaul.project.so.email.nototal', 'sale.order', 'addons/neopaul_project/report/sale_order_email_nototal.rml', parser=order_email, header="external")
