...
report_sxw.report_sxw('report.neopaul.project.so.email', 'sale.order', 'addons/neopaul_project/report/sale_order_email.rml', parser=order_email, header="external")
