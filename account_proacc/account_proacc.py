...
class account_proacc_api(osv.osv_memory):
	...
	company_id = self.pool.get('res.users').browse(cr, uid, uid).company_id.id
		...
		if invoice.type == 'out_invoice':
		    ...
		    vat_percent = line.invoice_line_tax_id and str(line.invoice_line_tax_id[0].amount * 100) or "0.0" # Should be improved for multiple and complex taxes
                    line_discount = ""
		    ...
		    delivery_add_zip = ""
		    delivery_add_city = ""
		    delivery_add_country = ""
		    vat_inclusive = 0
		    document_printed = 0
		      
                    # Get intracom code
                    intracom_code = line.invoice_line_tax_id and line.invoice_line_tax_id[0] and line.invoice_line_tax_id[0].proacc_intracom_code or "S" 
...
class account_fiscal_position(osv.osv):
    ...
    _columns = {
        "proacc_code": fields.char("ProAcc Code", size=3),
        "proacc_intracom_code": fields.char("ProAcc Intracom Code", size=1),
    }
...
class account_tax(osv.osv):
    ...
    _columns = { 
        'proacc_intracom_code': fields.selection([('S','s'),('L','l'),('T','t')], 'ProAcc Tax Code'),
    }  
